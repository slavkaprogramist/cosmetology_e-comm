package com.kosmetolog.admin.setting.state;
...
import com.kosmetolog.admin.settings.state.StateRepository;
...
public class StateRepositoryTests {
	...
	@Test
	public void testCreateStatesInUkraine() {
		Integer countryId = 1;
		Country country = entityManager.find(Country.class, countryId);
		
		//State state = repo.save(new State("Kherson", country));
	//	State state = repo.save(new State("Odessa", country));
		//State state = repo.save(new State("Kyiv", country));
	State state = repo.save(new State("Mykolaiv", country));
